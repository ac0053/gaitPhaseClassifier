...
with viewer.launch_passive(model, data) as v:
        ...
        while v.is_running() and step <= num_steps:
            ...
            kinematics_slice = full_kinematics[leg_idx, -1, 0][:, step % samps_per_step] 
            ...
            # need to append data after forward dynamics to get the correct joint velocities and torques
...
df.to_csv("csv_trajectory_datasets/gait_phase_LF_bkwds_trajectories.csv", index=False)
print("dataset saved!")
